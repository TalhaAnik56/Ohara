# Ohara - E-commerce Bookstore (Frontend)
...
- **Backend Technology:** The backend of Ohara is built using Django and PostgreSQL. I will update the link of the repository of Backend as soon as possible.<br>
   Framework: Django<br>
